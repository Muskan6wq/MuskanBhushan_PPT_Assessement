...
Objective:
Understand AWS Identity and Access Management using users and groups.

Description:
IAM users were created and added to IAM groups. Policies were attached to groups to manage permissions centrally.
...
Result:
Access control was managed using IAM users and groups.
