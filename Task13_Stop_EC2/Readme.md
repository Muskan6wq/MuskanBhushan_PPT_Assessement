Objective:
Control EC2 instance state using API calls.

Description:
API Gateway triggered a Lambda function to start or stop EC2 instances. SNS sent notifications on success or failure.
...
Result:
EC2 instance lifecycle automated using serverless services.
